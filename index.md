  ...
  - title: Research
    items:
      - title: "Romp: a manager for AI coding agents"
        ...
        description: "Open-source software for running many Claude Code agents at once. Tracks each agent's tasks, surfaces the ones needing decisions, and lets agents visibly coordinate and hand off work."
